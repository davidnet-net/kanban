<script lang="ts">
    ...
    const filterOptions = $derived([
        { label: $_("kanban.components.dayoverlay.field.filter_list.all_lists"), value: "" },
        ...listOptions
    ]);
    ...
    const filterListName = $derived(
        filterListId === "" 
        ? $_("kanban.components.dayoverlay.field.filter_list.all_lists")
        : lists.find((l: any) => l.id === filterListId)?.name
    );
    ...
    <div class="content">
        <header class="header">
            ...
            <div>
                <IconButton 
                    ...
                    alt={$_("kanban.components.cardoverlay.alt.close")} 
                />
            </div>
        </header>
        ...
        <div class="body-grid">
            ...
            <div class="section add-section">
                <div class="tabs">
                    <Button 
                        appearance={activeTab === 'create' ? "primary" : "subtle"}
                    ...
                    <Button 
                        appearance={activeTab === 'existing' ? "primary" : "subtle"}
                            ...
                            <div class="search-results">
                                {#each searchResults as card ((card as Card).id)}
                                    <div class="search-item">
                                        ...
                                        <Button 
                                            appearance="subtle" 
                                            onClick={() => attachExistingCard(card as Card)}
